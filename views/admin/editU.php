...
<html lang="en">
    ...
    <body>
        ...
        <form action="<?php echo constant('URL').'/administradores/updateU' ?>" method="POST">
            ...
            <input type="correo" name="correo" placeholder="Email" value="<?php if($this->correo!=-1){echo $this->correo;} ?>">
            <?php if($this->correo==-1){echo "<span style='color:red'>Este campo es requerido</span>";} ?><br><br>

            <input type="credito" name="credito" placeholder="credito" value="<?php if($this->credito!=-1){echo $this->credito;} ?>">
